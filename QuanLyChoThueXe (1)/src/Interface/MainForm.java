...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        //display images
//        btnDonHang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/calendar.png")));
//         resizeAndSetImageForButton(btnDonHang, "images/calendar.png", 40, 40);
//         resizeAndSetImageForButton(btnKhachHang, "images/person.png", 40, 40);
//         resizeAndSetImageForButton(btnXe, "images/passengercar.png", 60, 60);
    ...
    //create a function to resize the image si ut can fit the btn
...
//        Image imgae = imageIco.getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH);
//        label.seticon(new ImageIcon(image));
//    }
    
private void resizeAndSetImageForButton(JButton button, String imagePath, int width, int height) {
    try {
        // Sử dụng ClassLoader để đảm bảo tìm thấy tài nguyên
    ...
    private void initComponents() {
        ...
        btnDonHang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/calendar1.png"))); // NOI18N
        ...
        btnXe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/car.png"))); // NOI18N
    ...
    private void btnSuaXeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaXeActionPerformed
        ...
        if (selectedRow == -1) {
        JOptionPane.showMessageDialog(rootPane, "Vui lòng lựa chọn xe cần sửa trong bảng danh sách xe!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
        SuaXe suaXeForm = new SuaXe(this, jTable4);  
        suaXeForm.setVisible(true);  
    }
...
public void updateTableDonHang() {
    ...
    for (DonHang dh : res) {
        List<KhachHang> khList = bulKH.layKhachHangTheoMa(dh.getMaKH());
        List<Xe> xeList = bulXe.layXeTheoBienSo(dh.getBienSo());

        KhachHang kh = (khList != null && !khList.isEmpty()) ? khList.get(0) : null;
        Xe xe = (xeList != null && !xeList.isEmpty()) ? xeList.get(0) : null;

        tableModel.addRow(new Object[]{
            dh.getMaDon(),
            dh.getMaKH(),
            kh != null ? kh.getHoTen() : "Không tìm thấy",
            xe != null ? xe.getLoaiXe() : "Không tìm thấy",
            dh.getBienSo(),
            dh.getDiemDi(),
            dh.getDiemDen(),
            dh.getNgayDi(),
    ...
    if (!ma.equals("")) {
        ...
        // Nếu mã hợp lệ, tiếp tục tìm kiếm
        if (pass) {
            BULDonHang bul = new BULDonHang();
            ...
            if (res != null && !res.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Không tìm thấy đơn hàng với mã: " + MaDH, "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    } else {
        // Nếu không nhập mã, hiển thị lại toàn bộ bảng đơn hàng
        updateTableDonHang();
    }
...
//        }
    ...
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(rootPane, "Vui lòng lựa chọn xe cần xóa!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
    } else {

        DefaultTableModel model = (DefaultTableModel) jTable4.getModel();
        String bienSo = (String) model.getValueAt(selectedRow, 0);  
        String loaiXe = (String) model.getValueAt(selectedRow, 1);  
        Integer soCho = (Integer) model.getValueAt(selectedRow, 2);  
        ...
        int confirmed = JOptionPane.showConfirmDialog(
            null, 
            "Bạn có chắc chắn muốn xoá xe có Biển số: " + bienSo + "?", 
            "Cảnh báo", 
        ...
        if (confirmed == JOptionPane.YES_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Đã có lỗi xảy ra khi xóa xe!", "Thông báo", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace();
            }
        }
    }
